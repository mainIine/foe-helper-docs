---
description: Suivez l'achèvement des quêtes récurrentes pour obtenir des récompenses en diamants.
---
...
- [**Liste des tâches**](#liste-des-tâches) affichant les quêtes récurrentes ouvertes et terminées

## Configuration

![Menu de configuration](./.images/reglage.png)

Le menu de configuration permet d'afficher le compteur de badges, pour les QR non collectés, sur l'icône du menu<br>
...
**Q : Pourquoi certaines quêtes semblent-elles ouvertes même si je les ai déjà terminées ?**<br>
...
**Q : Mon montant de diamants n'a pas augmenté, mais certains RQ sont marqués comme terminés ?**<br>

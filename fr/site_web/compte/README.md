---
description: Compte sur Foe Helper
---
...
| **Votre nom en jeu**<br>(Your InGame Name)| Votre nom d'utilisateur Forge of Empires dans le jeu. |
...
![Menu des paramètres de FoE Helper](./.images/parametres.png)

## Exemple de formulaire rempli
![Exemple de formulaire d'inscription rempli](./.images/formulaire.png)
